...
<body>
    <!-- =========Header Top====== -->
    <header class="d-flex align-items-center headdd">
            ...
            <div class="row row_setting m-0 p-0">
                <div class="col-lg-6 class_phone p-0">
                    <div class="email_link">
                        <a class="" href="mailto:jamshidsalimov8@gmail.com">jamshidsalimov8@gmail.com</a>
                    </div>
                    <div class="phone_num">
                        <a href="tel:+998904571257">+998(99)-123-45-67</a>
                    </div>
                </div>
     ...
     <!-- ======= Header ======= -->
    <header id="header" class="d-flex align-items-center headerColor">
                    ...
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            <li class="dropdown"><a class="headerText" href="#">AKM haqida<i style="font-size: 9.5px;" class="bi bi-chevron-down"></i></a>
                                ...
                                <li><a class="headerDownText" href="#">ARM jamg'armasi</a></li>
