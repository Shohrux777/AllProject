    ...
    <div class="checked_show" >
      <div  class="ckeck_main_show  border">
        ...
        <div class="totalInfoShowCheck d-flex justify-content-between" style="border-top: 1px dashed black;">
          ...
          <h5 style="margin:0; padding:0 2px; font-weight:bold; font-size:13.5px;">{{options.summ}} <span style="font-size:13px;">Сум</span></h5>
        </div>
        ...
        <div class="totalInfoShowCheck d-flex justify-content-between" style="border-top: 1px dashed black;">
          ...
          <h4 style="margin:0; padding:0 2px; font-weight:bold; font-size:14px;" >{{parseInt(parseFloat(options.summ)-parseFloat(options.discount_summ)-parseFloat(options.online_sum))}} <span style="font-size:13.5px;">Сум</span></h4>
        </div>
