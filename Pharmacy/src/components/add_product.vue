    ...
    <div class="user_add py-3 px-4 ">
      <form >
          ...
          <mdb-col col="6" :class="{'col-9': status}" style="position: relative;" >
              ...
              <div v-if="single_product == 1" >
                <div scope="row" v-for="(data,rowIndex) in datasource.product_info" :key="rowIndex">
                  ...
                  <div class="shCode mx-3" style="width:100%; position: relative;">
                  ...
                  <!-- <div class="code mx-3" style="position: relative;" >
        ...
        <div class="mt-2 text-right">
          <!-- v-if="props_name == ''"  -->
          <mdb-btn v-show="false"  @click="submit_continue" size="sm" color="primary" m="r3" style="font-size: 10.5px"
