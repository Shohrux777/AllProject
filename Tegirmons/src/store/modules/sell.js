export default {
    ...
    mutations: {
        ...
        del_savat_page(state, i) {
            ...
            state.skidka_summ.splice(parseInt(i), 1);
        ...
        add_product_order(state, data) {
            ...
            if (state.zakaz_product_all_list[state.page_savat].length == 0) {
                ...
                if (s == 0) {
                    ...
                    state.zakaz_product_all_list[state.page_savat][index].qty = (parseFloat(state.zakaz_product_all_list[state.page_savat][index].qty) + parseFloat(a.qty)).toFixed(2);
    ...
    getters: {
        ...
        get_skidka_summ(state) {
            return state.skidka_summ;
        },
        CheckId(state){
