    ...
    async saveRasxod(){
      ...
      const requestOptions = {
        ...
        body: JSON.stringify({
          ...
          "tegirmonQarzUserTypeId": this.qarz_type.id,
          ...
          "note": this.note + '(' + this.client_info.fio + "ning " + this.qarz_type.name + "  qarz to'lov qildi. <<Qarz bo'limi>>)",
      ...
      try{
        this.loading = true;
        const response = await fetch(this.$store.state.hostname + "/TegirmonQarzUserRasxodType", requestOptions);
