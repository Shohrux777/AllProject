          ...
          <div class="main_table">
            <table class="w-100  mb-0 bg-white">
              ...
              <tr v-for="(row, index) in get_dashboard_list.rows" :key="index">
                  ...
                  <td>
                  <mdb-badge v-if="row.checktype == 'I'  || row.checktype == 'K'" badge="success" pill class="d-inline">Входить</mdb-badge>
                  <mdb-badge v-else badge="warning" pill class="d-inline">Выход</mdb-badge>
                  </td>
                  <td>{{row.door_name}}</td>
...
<script>
  import { mdbTable, mdbBtn, mdbBadge, mdbIcon,} from 'mdbvue'
