  ...
  <div class="info_davernost p-2" v-if="option">
    <div class="row mt-0 border-bottom">
      <div class="col-12 text-center">
        <p class="p-0 m-0 mt-2 font-weight-bold text-success" v-if="option.status_rasxod == 1" style="font-size: 14px;">Приход</p>
    ...
    <div class="row mt-1 border-bottom">
      ...
      <div class="col-8 ">
        <p v-if="option.status_rasxod == 1" class="p-0 m-0 mt-2 text-right" style="font-size: 14px;">{{option.image_url}}</p>
        <p v-else class="p-0 m-0 mt-2 text-right" style="font-size: 14px;">{{option.reserve}}</p>
      </div>
    </div>
    ...
    <div class="row mt-5">
      <div class="col-12 border-bottom text-center">
        <img :src="hostname + option.phone_number" style="width:98%" alt="">
      </div>
    </div>
