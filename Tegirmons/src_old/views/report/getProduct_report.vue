  ...
  export default {
    ...
    methods: {
      ...
      async apply(){
        ...
        try{
          this.loading = true;
          const response = await fetch(this.$store.state.hostname + "/TegirmonInvoice/getPaginationZahiragaOlibQolinganTovarlarListilarListi?page=0&size=1200&b_date="  + b_date + '&e_date='+ e_date);
          this.loading = false;
