<template>
  <div class="info_davernost p-4" v-if="option">
    ...
    <div class="row mt-2">
      <div class="col-3">
        <p class="p-0 m-0 mt-2" style="font-size: 14px;">Получить клиента</p>
      </div>
      <div class="col-9 border-bottom">
    ...
    <div class="row mt-2">
     ...
     <div class="row mt-2" v-if="option.auth">
      <div class="col-3">
...
methods:{
  printInfo(){
    this.$emit('printed', {id:this.option.id, client_id:this.option.tegirmonClientid})
  }
}
}
</script>
