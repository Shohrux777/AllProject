            ...
            <div class="row row_setting m-0 p-0">
                ...
                <div class="col-12 col-lg-6 class_icons p-0">
                    <div class="social-links">
                        <a href="https://www.youtube.com/channel/UCtPS7RSE10r2691hIdOkQQg/featured" target="_blank" class="icon_x twitter"><i class='bx bxl-youtube'></i></a>
        ...
        <div class="container-fluid header_top">
            <div class="row row_nawbar m-0 p-0">
                <a href="/" class="col-6 col-md-4 col-lg-3 col-xl-3 main_logo p-0">
                    <div class="img_box">
                        <img src="{{url('assets/images/3.png')}}" alt="png">
                    </div>
                    <div class="logo_text">
                ...
                <div class="col-3 col-md-8 col-lg-9 col-xl-9 main_nav p-0">
                    <nav id="navbar" class="navbar">
                        <ul>
                            ...
                            <li >
                                <a style="font-size: 13.5px;" class="nav-link headerText scrollto" href="/categoryId/6">Elektron kutubxona</a>
                            </li>
                            ...
                            <li><a class="nav-link headerText scrollto" href="/login">Kirish</a>
                            </li>
                        </ul>
            ...
            <div class="container">
                <div class="row row_footer m-0 p-0 w-100">
                    ...
                    <div class="col-11 col-sm-10 col-md-6  col-lg-2 footer-links">
                        <h4>Ma'lumot</h4>
                        <ul>
                            <li><i class="bx bx-chevron-right"></i> <a href="/management">Rahbariyat</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="/hestory">AKM tarxi</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="/workplace">Bo'sh ish o'rni</a></li>
                            <li><i class="bx bx-chevron-right"></i> <a href="/systemall">Tuzilma</a></li>
                        </ul>
                    </div>
