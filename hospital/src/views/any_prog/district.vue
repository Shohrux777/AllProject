  ...
  export default {
    ...
    methods: {
      ...
      async for_delete(del_data,index){
          ...
          const response = await fetch(this.$store.state.hostname + "/Districts/" + del_data.id, requestOptions);
          ...
          if(data)
          {
            ...
            this.district_row_delete(index);
          }
          else{
