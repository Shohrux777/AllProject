    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeight"  >
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight:bold; " class="mb-5 headerTitle">Анализ мочи по нечипоренко</h3>
          ...
          <table border  class="allWidthLabTable" style="margin-top:35px;">
            <thead>
              <tr >
                ...
                <!-- <th  class="fs font-weight-bold py-2">Ед.измер</th> -->
              </tr>
            </thead>
            <tbody >
              <tr>
                ...
                <td class="fs">До 2000</td>
                <!-- <td class="fs">2000</td> -->
                <!-- <td class="fs">в 1 мл </td> -->
              </tr>
              <tr>
                <td class="fs">Эритроциты</td>
                <td class="fs">{{option.eritrositi}}</td>
                <td class="fs">До 1000</td>
                <!-- <td class="fs">1000</td> -->
                <!-- <td class="fs">в 1 мл </td> -->
              </tr>
              <tr>
                <td class="fs">Цилиндры</td>
                <td class="fs">{{option.silindri}}</td>
                <td class="fs">Abs</td>
                <!-- <td class="fs">20</td> -->
                <!-- <td class="fs">в 1 мл </td> -->
              </tr> 
...
export default {
 async mounted() {
  ...
  async created(){
    if(this.id>0){
      this.loading =true;
      const response = await fetch(this.$store.state.hostname + '/HospitalNechiporenko/' + this.id)
  ...
  methods: {
    ...
    async send(){
      ...
      const requestOptions = {
        ...
        body: JSON.stringify({
        "analiz_name": "Анализ мочи по нечипоренко",
        "analiz_base_str": this.base64,
        "id": 0,
        "patientsId": this.option.patientsId,
        "sended_status":  true,
        "doctor_name": 'nechiporenko_print',
