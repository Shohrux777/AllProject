    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeight">
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight:bold;  " class="mb-5 headerTitle">Антитела  классов GМ  к  Treponema pallidum RW-СИФИЛИС </h3>
          ...
          <table border class="allWidthLabTable" style="margin-top:35px;">
            ...
            <tbody >
              <tr>
                <td class="fs">Антитела  классов GМ  к  Treponema pallidum RW-СИФИЛИС</td>
                <td class="fs">{{option.syplhilis_rpr}}</td>
                <td class="fs"> {{simbol}}0,481</td>
              </tr>
  ...
  methods: {
    ...
    async send(){
      ...
      const requestOptions = {
        ...
        body: JSON.stringify({
        "analiz_name": "Антитела  классов GМ к Treponema pallidum RW-СИФИЛИС ",
