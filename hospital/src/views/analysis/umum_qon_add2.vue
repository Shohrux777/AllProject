   ...
   <loader v-if="loading"/>
    <div v-else class="mx-1 row">
      ...
      <div class="col-6" >
        ...
        <div style="position:relative;">
          <mdb-input :label="('Коэффициент больших тромбоцитов (P-LCR)')"  v-model="sredniy_obyom_trombositov" outline/>
          <!-- <small v-if="$v.sredniy_obyom_trombositov.$dirty && !$v.sredniy_obyom_trombositov.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <small class="pos_absolute">13 - 43</small>
        </div>
        <div style="position:relative;">
