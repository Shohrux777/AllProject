<template>
  <div class="name_23ya bg-white" style="min-height: 100vh;">
    <div  class="header text-center border-bottom py-2">
      <h4 class=" text-primary">МАЗОК НА СТЕПЕНЬ ЧИСТОТЫ</h4>
    </div>
    <div class="row mt-2">
      <div class="col-4">
    ...
    <div v-else class="mx-1 row">
      <div class="col-4">
        <div style="position:relative;">
          <mdb-input :label="('Микрофлора (V)')"  v-model="name_1" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Микрофлора (C)')"  v-model="name_2" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Микрофлора (U)')"  v-model="name_3" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эпителий (V)')"  v-model="name_4" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эпителий (C) ')"  v-model="name_5" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эпителий (U)')"  v-model="name_6" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лейкоциты (V) ')"  v-model="name_7" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лейкоциты (C) ')"  v-model="name_8" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лейкоциты (U)')"  v-model="name_9" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эритроциты (V) ')"  v-model="name_10" outline/>
          <!-- <small v-if="$v.name_10.$dirty && !$v.name_10.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">± (норм)</small> -->
        </div>
        <div style="position:relative;">
          <mdb-input :label="('Эритроциты (C)')"  v-model="name_11" outline/>
      ...
      <div class="col-4" >
        ...
        <div style="position:relative;">
          <mdb-input :label="('Эритроциты (U) ')"  v-model="name_12" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Гонококки (V)')"  v-model="name_13" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Гонококки (C)')"  v-model="name_14" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Гонококки (U)')"  v-model="name_15" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Трихомонады (V)')"  v-model="name_16" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Трихомонады (C)')"  v-model="name_17" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Трихомонады (U) ')"  v-model="name_18" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Ключевые клетки (V)')"  v-model="name_19" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Ключевые клетки (U)')"  v-model="name_20" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Ключевые клетки (C)')"  v-model="name_21" outline/>
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лептотрекс (V)')"  v-model="name_22" outline/>
      ...
      <div class="col-4" >
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лептотрекс (C)')"  v-model="name_23" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Лептотрекс (U)')"  v-model="name_24" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Дрожжи (V) ')"  v-model="name_25" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Дрожжи (C)')"  v-model="name_26" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Дрожжи (U)')"  v-model="name_27" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Слизь (V)')"  v-model="name_28" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Слизь (C)')"  v-model="name_29" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
        ...
        <div style="position:relative;">
          <mdb-input :label="('Слизь (U)')"  v-model="name_30" outline/>
          <!-- <small v-if="$v.name_22.$dirty  && !$v.name_22.required" class="invalid-text  pl-4" style="position:absolute; bottom:-18px; left:-15px;"> 
            {{$t('select_item')}}
          </small> -->
          <!-- <small class="pos_absolute">abs</small> -->
  ...
  async created()
    {
      if(this.id > 0)
      {
        const res = await fetch(this.$store.state.hostname + '/HospitalAnaliz_19/getFullInfoById?id=' + this.id);
    ...
    async send(){
      ...
      try{
        ...
        const requestOptions = {
          ...
          "device_name": "mazok_step_print",
          "doctor_name": this.doctor_name,
          "creator_doctor_name": localStorage.docName
          })
        };
        this.loading = true;
        const response = await fetch(this.$store.state.hostname + '/HospitalAnaliz_19', requestOptions)
        const data = await response.json()
          console.log(data)
        ...
        if(data.id){
          ...
          this.loading = false;
          this.$refs.message.success('Added_successfully')
          this.$router.push('/mazok_step_print/' + data.id)
        }
        else{
          // this.$refs.msg.error('Error_successfully')
          this.loading = false;
