<template>
  <div class="main_lab_add">
    <div class="header_lab d-flex justify-content-center text-center border-bottom">
      <svg @click="$router.back()" xmlns="http://www.w3.org/2000/svg" style="position: absolute; left: 10px; top:5px; cursor:pointer;"
        class="icon icon-tabler icon-tabler-chevron-left" width="22" height="22" viewBox="0 0 24 24" stroke-width="2.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        <polyline points="15 6 9 12 15 18" />
      </svg>
        <h5 class="m-0 p-0 py-2 text-info" style="font-size: 15.7px;">Добавить лабораторию</h5>
    </div>
    <div class="main_header_lab_added border-bottom px-4" :class="{'applied': main_id != null}">
      <div class="row pt-2">
              ...
              <template slot="accordion-content" >
                <table bordered class="w-100">
                  <tbody>
                    <tr>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name1" />
                      </td>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name2" />
                      </td>
                    </tr>
                    <tr>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name3" />
                      </td>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name4" />
                      </td>
                    </tr>
                    <tr>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name5" />
                      </td>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name6" />
                      </td>
                    </tr>
                    <tr>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name7" />
                      </td>
                      <td class="px-4">
                        <mdb-input  type="text" size="sm" class="w-100 m-0 py-1" v-model="table.name8" />
                      </td>
                    </tr>
                  </tbody>
                </table>
      ...
      <div class="text-end pb-2">
        <mdb-btn class="py-2 px-3" @click="submitMain" style="font-size: 9px;" color="success">{{$t('add_main')}}</mdb-btn>
      </div>
    </div>

    <div class="lab_items_add  px-4">
      <div class="container-fluid content_lab_item_last card mt-3" v-for="(i, index) in number_list" :key="index">
        ...
        <div class="row">
          ...
          <div class="col-3" v-if="main_value.lab_name_s">
          ...
          <div class="col-3" v-if="main_value.norma_s">
            <vue-editor style="width:100%;" :placeholder="main_value.norma" :editorToolbar="customToolbar" v-model="norma_list[i-1].name2"></vue-editor>
        ...
        <div class="content_lab_item_last_icons d-flex" v-if="i == number_list">
          ...
          <div class="bg-danger rounded py-1 px-2 mr-1" v-if="number_list != 1" @click="remove_item_lab_item(i-1)">
      ...
      <div class="text-end pb-2" v-if="main_id != null">
        <mdb-btn class="py-2 px-3" @click="submitItems" style="font-size: 10px;" color="success">{{$t('add_lab')}}</mdb-btn>
      </div>
    </div>
...
export default {
  ...
  methods:{
    ...
    remove_item_lab_item(i){
      ...
      this.result_name_list[i].name5 = '';
      this.second_name_list[i].name6 = '';
      console.log(this.lab_name_list);
