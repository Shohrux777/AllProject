  ...
  <div class="main_lab_add">
    <div class="header_lab d-flex justify-content-center text-center border-bottom">
      <svg @click="$router.back()" xmlns="http://www.w3.org/2000/svg" style="position: absolute; left: 10px; top:5px; cursor:pointer;"
        ...
        <h5 class="m-0 p-0 py-2  text-success">Добавить лабораторию</h5>
    </div>
    <div class="main_header_lab_added border-bottom px-4" :class="{'applied': main_id != null}">
      ...
      <div class="text-end pb-2">
        <mdb-btn class="py-2 px-3" @click="submitMain" style="font-size: 10px;" color="success">{{$t('add_main')}}</mdb-btn>
      </div>
    </div>
