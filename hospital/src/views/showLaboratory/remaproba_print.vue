    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeight"  >
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight:bold; " class="mb-5 headerTitle">Ревмопробы</h3>
          ...
          <table border class="allWidthLabTable" style="margin-top:35px;">
            <thead>
              <tr >
                <th  class="fs font-weight-bold">№</th>
            ...
            <tbody >
              <tr>
                <td class="fs">1</td>
                <td class="fs">С-реактивний белок (СРБ)</td>
                <td class="fs">{{option.srb}}</td>
                <td class="fs"> 0-20 IU/mL</td>
                <!-- <td class="fs"> 6 мг/л</td> -->
              </tr>
              <tr>
                <td class="fs">2</td>
                <td class="fs">Ревматоидный фактор (РФ)</td>
                <td class="fs">{{option.rf}}</td>
                <td class="fs">0-6  IU/mL </td>
                <!-- <td class="fs">12 ед/л </td> -->
              </tr>
              <tr>
                <td class="fs">3</td>
                <td class="fs">Антистрептолизин-О (асло)</td>
                <td class="fs">{{option.aslo}}</td>
                <td class="fs">0-200 IU/mL </td>
                <!-- <td class="fs">200 ед/л </td> -->
              </tr>
...
export default {
 async mounted() {
  ...
  async created(){
    if(this.id>0){
      this.loading =true;
      const response = await fetch(this.$store.state.hostname + '/HospitalRemaproba/' + this.id)
