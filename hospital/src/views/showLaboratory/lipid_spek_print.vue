    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeightAll"  >
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight:bold; " class="mb-5 headerTitle">Липидный спектр</h3>
          ...
          <table border class="allWidthLabTable" style="margin-top:35px;">
            ...
            <tbody >
              ...
              <tr>
                <td class="fs">1</td>
                <td class="fs">Общий холестерин </td>
                <td class="fs">{{option.name_1}}</td>
                <td class="fs"><p class="m-0 p-0 pb-1">{{simbol}}=5,2 ммоль/л</p>
                  
                </td>
              </tr>
              <tr>
                <td class="fs">2</td>
                <td class="fs">ЛПВП-холестерин</td>
                <td class="fs">{{option.name_2}}</td>
                <td class="fs">
                  <p class="m-0 p-0 pb-1">жен - 1.15 ммоль/л </p>
                  <p class="m-0 p-0 pb-1">муж - >0.9 ммоль/л </p>
                </td>
              </tr>
              <tr>
                <td class="fs">3</td>
                <td class="fs">ЛПНП- холестерин</td>
              ...
              <tr>
                <td class="fs">4</td>
                <td class="fs">Триглицериды</td>
                <td class="fs">{{option.name_4}}</td>
                <td class="fs">
                  <p class="m-0 p-0 pb-1">{{simbol}}= 2,3 ммоль/л </p>
                </td>
              </tr>
              <tr>
                <td class="fs">5</td>
                <td class="fs">Коэффициент аторогенности</td>
                <td class="fs">{{option.name_5}}</td>
                <td class="fs">{{simbol}} 3-3,5
                </td>
              </tr>
            </tbody>
          </table>
...
export default {
 async mounted() {
  ...
  async created(){
    if(this.id>0){
      this.loading =true;
      const response = await fetch(this.$store.state.hostname + '/HospitalAnaliz_9/getFullInfoById?id=' + this.id)
