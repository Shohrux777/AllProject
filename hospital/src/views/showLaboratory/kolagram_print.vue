    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeightAll"  >
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          <h3 style="width:100%; text-align:center; font-weight:bold; " class="mb-5 headerTitle">Коагулограмма</h3>
          ...
          <table border class="allWidthLabTable" style="margin-top:35px;">
            ...
            <tbody >
              ...
              <tr>
                <td class="fs">1</td>
                <td class="fs">Фибриноген</td>
                <td class="fs">{{option.name_1}}</td>
                <td class="fs"><p class="m-0 p-0 pb-1">M: 200-400 мг/дл</p>
              ...
              <tr>
                <td class="fs">2</td>
                <td class="fs">Активное частичное тромбопластиновое время</td>
                <td class="fs">{{option.name_2}}</td>
                <td class="fs">24-42 сек
                </td>
              </tr>
              <tr>
                <td class="fs">3</td>
              ...
              <tr>
                <td class="fs">5</td>
                <td class="fs">Тромбиновое время</td>
                <td class="fs">{{option.name_5}}</td>
                <td class="fs">{{simbol}} 30 сек
                </td>
              </tr>
              <tr>
                <td class="fs">6</td>
                <td class="fs">Тромбиновое время (соотношение) </td>
              ...
              <tr>
                <td class="fs">7</td>
                <td class="fs">АЧТВ (соотношение)</td>
...
export default {
 async mounted() {
  ...
  async created(){
    if(this.id>0){
      this.loading =true;
      const response = await fetch(this.$store.state.hostname + '/HospitalAnaliz_3/getFullInfoById?id=' + this.id)
