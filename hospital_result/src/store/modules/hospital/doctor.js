export default {
    ...
    mutations: {
        UpdateAuth_patient_list(state, data) {
            console.log('data update qilayabdi listni')
            // console.log(data)
            state.patient_auth_id = data;
        },
        UpdateService_patientId(state, data) {
            console.log('bu patient id buni ham ichiga kiryabdi')
            console.log(data)
        ...
        UpdateService_patientId_for_finish(state, data) {
            console.log('bu for finidh data')
            console.log(data)
        ...
        UpdateServiceListForSelect(state,i){
            ...
            state.ServiceListForSelect.push({ payedDate: '1'})
