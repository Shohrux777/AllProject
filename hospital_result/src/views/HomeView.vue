    ...
    <div class="rv_lab allWidthLab" id="table" style="position:relative;">
      ...
      <div class="lab_answer upHeightAllspirma320">
        <div class=" " style="display:flex; justify-content:center; flex-direction:column;">
          ...
          <table border class="allWidthLabTable" style="margin-top:15px;">
            <thead>
              <tr>
        ...
        <p v-if="option.hospitalAnalizDynamicmain.name_13" class="font-weight-bold mt-3" style="font-size:20px;"> {{option.hospitalAnalizDynamicmain.name_13}} </p>
        <p v-if="option.hospitalAnalizDynamicmain.name_14" class="font-weight-bold mt-3 " style="font-size:20px;"> {{option.hospitalAnalizDynamicmain.name_14}}: <span class="ml-4">{{option.extra1}}</span> </p>
