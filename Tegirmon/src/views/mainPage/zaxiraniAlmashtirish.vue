  ...
  <div class="zaxira">
    ...
    <div v-else class="getProduct  my-4" >
      ...
      <div class="mainWorkChange m-0" :class="{'bg_red_color': oshibka_client == 1}">
        ...
        <div class="row px-4 pb-3 bg-warning mt-3" v-if="showObyom" :class="{'bg_danger': product_real_qty_fix<-1}">
          <div class="px-3 w-100 bg-warning shadow" style="position: sticky; top:0; z-index: 99999;">
            <div class="row w-100 " >
...
data(){
  ...
  methods: {
    ...
    fetchChangeSubPro(qty){
      ...
      this.zaxiraCheckList({list: this.changeProduct, product_name: this.product_name, buy_qty: this.product_buy, buy_sum: this.summ_buy, client_name: this.olib_ketuvchi, client: this.client_info, client_key: this.parol_tg})
    },
    ...
    async saveChanging(){
      ...
      for(let i=0; i<this.changeProduct.length; i++){
        ...
        console.log(this.changeProduct)
          ...
          console.log(this.changeProduct[i].persantage)
