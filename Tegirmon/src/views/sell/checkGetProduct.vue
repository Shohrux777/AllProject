      ...
      <div class="infoHeader" style="width:100%;">
        ...
        <div style="margin: 5px 0px;">
          <div  style=" display:flex; flex-wrap: wrap; justify-content: space-between;  margin-top:3px;">
            ...
            <span style="font-size: 12.5px; font-weight:bold;" class="paymentCheckPrintCheck">{{check_get_invoice.created_date_time.slice(0,10)}} <span class="ml-1">{{check_get_invoice.created_date_time.slice(11,16)}}</span></span>
          </div>
        </div>
      </div>
      <div class="infoHeader" style="width:100%;">
