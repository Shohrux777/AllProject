      ...
      <div class="infoHeader" style="width:100%;">
        ...
        <div style="margin: 5px 0px;">
          <div  style=" display:flex; flex-wrap: wrap; justify-content: space-between;  margin-top:3px;">
            ...
            <span style="font-size: 13px; font-weight:bold" class="paymentCheckPrint">{{zaxiraListInvoice[0].date.slice(0,10)}} <span class="ml-1">{{zaxiraListInvoice[0].date.slice(11,16)}}</span></span>
          </div>
        </div>
      </div>
