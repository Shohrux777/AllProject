      ...
      <loader  v-if="loading"/>
        <div class="navbar_Nav_Edit d-flex justify-content-between"  container>
            <div class="d-flex align-items-center">
                <span to="#"> <span class="text-white">Пришел на работу</span> </span>
            </div>
            <div >
...
export default {
    ...
    methods:{
      ...
      async fetchWithoutDept(){
        ...
        console.log('submit')
        try{
          const response = await fetch(this.$store.state.hostname + "/SkudMyUserinfoes/getReportKelganlarAllUsers?page=0&size=1000&need_date=" + start);
