...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("tegirmon_order_client_rasxod")]
    public class TegirmonOrderClientRasxod : TegirmonBaseModel
    {
        ...
        public double? hisob_sum { get; set; } = 0.0;
        public double? hisob_dollor { get; set; } = 0.0;
        public double? cash_or_product { get; set; } = 0.0;
        public String note { get; set; }
        public String image_url { get; set; }
        public String addiotionala_information { get; set;}
        public long TegirmonOrderClientId { get; set; }
        public TegirmonOrderClient orderClient { get; set; }
