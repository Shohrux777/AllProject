...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("tegirmon_qarz_user_rasxod_type")]
    public class TegirmonQarzUserRasxodType : TegirmonBaseModel
    {
        ...
        public long? TegirmonQarzUserTypeId { get; set; }
        public TegirmonQarzUserType dolg_type { get; set; }
