...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("tegirmon_invoice_item_new")]
    public class TegirmonInvoiceItemNew : TegirmonBaseModel
    {
        public long TegirmonInvoiceid { get; set; }

        [System.Text.Json.Serialization.JsonIgnore]
        [Newtonsoft.Json.JsonIgnore]
        public TegirmonInvoiceNew invoice { get; set; }
