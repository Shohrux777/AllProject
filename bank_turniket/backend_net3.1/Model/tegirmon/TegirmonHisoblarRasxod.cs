...
{
    [System.ComponentModel.DataAnnotations.Schema.Table("tegirmon_hisoblar_rasxod")]
    public class TegirmonHisoblarRasxod : TegirmonBaseModel
    {
        ...
        public double perichsleniya { get; set; } = 0.0;
