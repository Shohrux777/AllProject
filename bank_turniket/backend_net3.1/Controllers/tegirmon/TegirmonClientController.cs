...
namespace ApiAll.Controllers.tegirmon
{
    ...
    public class TegirmonClientController : ControllerBase
    {
        ...
        [HttpPost("getSaveBase64ImagesToFolderAndGetImageUrls")]
        public async Task<ActionResult<TegirmonImageTempDouble>> getSaveBase64ImagesToFolderAndGetImageUrls(TegirmonImageTempDouble image_temp)
        {
            image_temp.image_url_1 = saveImageToFolder(image_temp.image_base_64_1);
            image_temp.image_url_2 = saveImageToFolder(image_temp.image_base_64_2);
