...
namespace ApiAll.Controllers.tegirmon
{
    ...
    public class TegirmonOstatkaController : ControllerBase
    {
        ...
        public async Task<ActionResult<TexPaginationModel>> getPagination([FromQuery] int page, [FromQuery] int size)
        {
            ...
            paginationModel.items_count = await _context.TegirmonOstatka.Where(p => p.active_status == true).CountAsync();
        ...
        public async Task<ActionResult<TexPaginationModel>> getPaginationOstatkaProduct_Id([FromQuery] int page, [FromQuery] int size, [FromQuery] long product_id)
        {
            TexPaginationModel paginationModel = new TexPaginationModel();
            List<TegirmonOstatka> categoryList = await _context.TegirmonOstatka
                .Include(p => p.product)
            ...
            paginationModel.items_list = JArray.FromObject(categoryList);
            paginationModel.items_count = await _context.TegirmonOstatka.Where(p => p.active_status == true && p.TegirmonProductid == product_id).CountAsync();
            paginationModel.current_item_count = categoryList.Count();
            paginationModel.current_page = page;
            return paginationModel;
        }
