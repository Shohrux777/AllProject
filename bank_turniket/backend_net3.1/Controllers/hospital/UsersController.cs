...
namespace ApiAll.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        [HttpPost("sendSmsWithPlayMobile")]
        public async Task<ActionResult<Users>> sendSmsWithPlayMobile([FromQuery] String login,
            [FromQuery] String password_s, [FromQuery] String url_str, [FromQuery] String phone_number,
            [FromQuery] String sms_txt)
        {
            
            String user = login;
            String password = password_s;
            String full_url = url_str;
            ...
            try
            {
                ...
                else
                {
                    ...
                    return BadRequest(answer.StatusCode);
                }
