export default {
    ...
    mutations: {
        ...
        getDiscoundAndDolg(state,data){
            state.skidka_dolg = data;
        },
        ...
        add_product_order(state, data) {
            ...
            if(data.contains_number_in_pack>1){
                var a = {
                ...
                var a = {
                    ...
                    qty_in_pack: parseFloat(data.unit),
                    posInvoiceid: 0,
                    invoiceItemId: data.invoice,
                    expired_date: data.expired_date,
                    contains_number_in_pack: data.contains_number_in_pack,
            ...
            if (state.zakaz_product_all_list[state.page_savat].length == 0) {
                ...
                if (s == 0) {
                    ...
                    if(a.contains_number_in_pack>1){
                        ...
                        state.zakaz_product_all_list[state.page_savat][index].qty = parseFloat(state.zakaz_product_all_list[state.page_savat][index].qty) + parseFloat(a.qty);
                        state.zakaz_product_all_list[state.page_savat][index].summ = parseFloat(state.zakaz_product_all_list[state.page_savat][index].summ) + parseFloat(a.summ);
                        state.zakaz_product_all_list[state.page_savat][index].summ = parseFloat(state.zakaz_product_all_list[state.page_savat][index].summ.toFixed(2))
                        state.zakaz_product_all_list[state.page_savat][index].qty_in_pack = parseFloat(state.zakaz_product_all_list[state.page_savat][index].qty_in_pack) + parseFloat(a.qty_in_pack);
                        state.zakaz_product_all_list[state.page_savat][index].addShow = true;
                    }
    ...
    getters: {
        ...
        get_skidka_dolg(state){
            return state.skidka_dolg;
        }
