<template>
  <div>
    ...
    <div class="user_add py-3 px-4 ">
      <form >
        <mdb-row>
          <mdb-col col="2" :class="{'col-3': status}">
            <p class="p-0 m-0 mt-2" style="font-size: 14px;">{{$t('name')}}</p>
          </mdb-col>
          <mdb-col col="6" :class="{'col-9': status}"> 
              ...
              <div class="border border-primary rounded priceCode px-1 py-3 mt-2">       
                ...
                <div >
                  ...
                  <div class="d-flex " style="width:100%;" >
                    <div v-show="false" class="shCode mx-3" style="width:50%; position: relative;">
                      <small class="" style="color: gray; position:absolute; top:-19px; left:5px; font-size: 12px;" >
                        {{$t('dozirofka')}}
                      </small>
                      <div>
                    ...
                    <div v-show="false" class="code mx-3" style="width:50%; position: relative;" >
        ...
        <mdb-row class="mt-4">
          ...
          <mdb-col col="5" :class="{'col-9': status}" style="position: relative;">
              <erpSelect
        ...
        <mdb-row class="mt-4" v-show="false">
          ...
          <mdb-col col="5" :class="{'col-9': status}"> 
        ...
        <mdb-row class="pt-4">
          ...
          <mdb-col col="6" :class="{'col-9': status}" style="position: relative;" >
               <!-- Single product -->
              ...
              <div v-if="single_product == 1" >
                <div scope="row" v-for="(data,rowIndex) in datasource.product_info" :key="rowIndex">
                  ...
                  <div class="shCode mx-3" style="width:60%; position: relative;">
                  ...
                  <div class="code mx-3" style="width:40%; position: relative;" >
                ...
                <div class="d-flex mt-4" style="width:100%;">
                  ...
                  <!-- Multiple product -->
              <div v-show="false" class="border border-primary rounded priceCode px-1 py-2 mt-2">
                <div class="custom-control custom-radio pb-3">
        ...
        <mdb-row class="mt-4">
          ...
          <mdb-col col="3" :class="{'col-9': status}"> 
        ...
        <div class="mt-2 text-right">
          <mdb-btn v-if="props_name == ''"  @click="submit_continue" size="sm" color="primary" m="r3" style="font-size: 10.5px"
            p="r4 l4 t2 b2">  {{$t('Add_and_barcode')}}
          </mdb-btn>
...
export default {
  ...
  validations: {
    ...
    async created()
    {
      ...
      if(this.id > 0)
      {
        ...
        if(data.subProductList.length == 0){
           ...
           this.datasource.product_info[0].code = data.optom_price;
           if(data.barcodeList.length > 0){
            this.datasource.product_info[0].barcodeList[0].barcode = data.barcodeList[0].barcode;
           }
           else{
            this.datasource.product_info[0].barcodeList[0].barcode = data.barcode;
           }
    ...
    async mounted(){
      ...
      if(this.props_name != ''){
        this.fullname = this.props_name + ' ' + this.dozirovka + ' ' + this.Fvip + ' №' + this.numberDrag;
      }
  ...
  methods:{
    ...
    save_data :  async function(){
      ...
      console.log(this.datasource.product_info[0].percentage)
        var img = document.getElementById('prewImage');
        if(img.src.slice(0,4) != 'http'){
          this.base64 = img.src;
        }
        console.log(this.datasource.product_info[0].barcodeList[0].barcode)
        if(this.$v.$invalid)
          {
            this.$v.$touch();
          ...
          const requestOptions = {
            ...
            body: JSON.stringify({
              ...
              "optom_price": parseInt(this.datasource.product_info[0].code),   //optim price
              "code": this.measurment_name,   //measurement
              "price": this.price,
              "buyed_price": this.buyed_price,
              "image": this.base64,
              "min_qty": this.minqty,
              "percentage": this.datasource.product_info[0].percentage,
              ...
              "info": this.note,
              "publisher_name": this.measurment_name,
              "note": this.note,
            })
          };
    ...
    async submit_continue()
      {
        ...
        {
          if(this.id != 0){
            this.$router.push('/barcode/' + this.last_id)
            this.cls_wnd();
          }
          else{
            this.$router.push('/barcode/' + this.last_id)
