...
const routes = [{
    ...
    },
    {
        ...
        meta: { layout: 'empty' },
        component: () =>
            import ('../views/report/checkList.vue')
    },
    {
        path: '/dolgClientList',
        name: 'dolgClientList',
        meta: { layout: 'empty' },
        component: () =>
            import ('../views/report/dolgClientList.vue')
    },
    {
        path: '/pay_dolg_client',
        name: 'pay_dolg_client',
        meta: { layout: 'empty' },
        component: () =>
            import ('../views/report/pay_dolg_client.vue')
    },
    {
        path: '/client_info_by_id',
        name: 'client_info_by_id',
        meta: { layout: 'empty' },
        component: () =>
            import ('../views/report/client_info_by_id.vue')
    },
    {
        path: '/postavchik_report',
        name: 'postavchik_report',
        meta: { layout: 'main' },
        component: () =>
            import ('../views/buy/postavchik_report.vue')
    },
    ...
    },
    {
        ...
        meta: { layout: 'empty' },
        component: () =>
            import ('../views/product/barcode.vue')
    },
    {
        path: '/creditors_pay',
        name: 'creditors_pay',
