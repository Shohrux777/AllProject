...
<div>
  ...
  <div v-else class="aptekaSale" >
    <div class="saleHeader border-bottom d-flex justify-content-between align-items-center"  v-on:click.capture="focusBarcode">
      <div class="d-flex">
        <router-link to="/getSaledSummOfKassirListBeatweenDateReport">
        ...
        <div class="d-flex" v-on:click.capture="focusBarcode">
          <div class="w-50">
            <div class="text-center mt-1 linkMain" style="padding: 9.2px 0;" @click="$router.push('/checkList')">
              <span class="m-0 p-0 " >{{$t('check_list')}} </span>
            </div>
            <div class="text-center mt-1  linkMain"  @click="$router.push('/dolgClientList')" style="padding: 9.2px 0;">
              <span class="m-0 p-0 " >{{$t('client_dolg')}}</span>
            </div>
            <div class="text-center mt-1  linkMain"  @click="$router.push('/pay_dolg_client')" style="padding: 9.2px 0;">
              <span class="m-0 p-0 " >{{$t('pay_client')}}</span>
            </div>
            <div class="text-center mt-1  linkMain" @click="$router.push('/client_info_by_id')" style="padding: 9.2px 0;">
              <span class="m-0 p-0 " >{{$t('client_info')}}</span>
            </div>
          ...
          <div class="w-50">
            ...
            <mdb-btn color="warning" style="font-size:11px; padding: 12px 0;" @click="clickPay" class="m-0  mt-1 w-100"> {{$t('perechisliniya')}}</mdb-btn>
      ...
      <div class="acceptBox px-3 py-2">
        ...
        <div class="d-flex mt-3">
          <div class="skidka " style="width:35%">
            <div style="position:relative;" @click="changeOptimPrice(dataAccept.optom_price)">
              <input type="text" v-model="dataAccept.optom_price" disabled class="form-control form-control-sm border mt-2 text-right" style="border:none; outline:none;font-weight:bold;" >
              <small style="position:absolute; top:-16px; left:3px;">
                {{$t('optim_price')}}
              </small>
            </div>
            <div style="position:relative;" @click="changeMainPrice(dataAccept.realPriceSaled)">
              <input type="text" v-model="dataAccept.realPriceSaled" disabled class="form-control form-control-sm border mt-3 text-right" style="border:none; outline:none;font-weight:bold;" >
              <small style="position:absolute; top:-16px; left:3px;">
                {{$t('main_price')}}
              </small> 
            </div>
