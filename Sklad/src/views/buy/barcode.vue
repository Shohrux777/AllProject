<template id="txtSearch">
  <form v-on:submit.prevent="acceptBarcode">
    <input v-on:keyup.enter="acceptBarcode" style="position:absolute; top:-100%; left: -100%;" ref="dontshow"/>
    <loaderTable v-if="loading"/>
    <div  v-else class="barcode" style="width: 200px; margin-top:40px; margin-left: -30px; margin-bottom:0; transform: rotate(90deg)" >
